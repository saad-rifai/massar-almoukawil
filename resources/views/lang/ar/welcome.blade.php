@section('title', "آليات دعم و مواكبة المقاولات لجهة طنجة تطوان الحسيمة")
...
@include('lang.ar.assets.head')

<body id="boddy">
    <div class="container-lg">

        @include('lang.ar.assets.navbar')
        <div class="row body_row mt-3">
            <div class="col col-3 col-xxl-2 position-relative">
                <div id="menu_li">
                    <div class="card_bg_white full_raduis col_card_1">
                        ...
                        <div class="card_body menu_li">
                            <ul class="side-bar-links">
                                ...
                                <li><a href="#">إيجاد وتقييم فكرة مقاولتك</a>
                                ...
                                <li><a href="#">تمويل مشروع مقاولتك </a>
                                    <ul class="side_menu_hover_container_menu_li">
                                        <li>
                                            <a
                                ...
                                <li><a href="#">حماية فكرة مقاولتك</a>
                                    <ul class="side_menu_hover_container_menu_li">
                                        <li>
                                            <a
                                ...
                                <li>
                                    <a href="#">تنفيذ إجراءات إنشاء مقاولتك</a>
                                    <ul class="side_menu_hover_container_menu_li">
                                        <li>
                                            <a
                                ...
                                <li><a href="#"> تحسين إستراتيجية التسويق الرقمي</a>
                                    <ul class="side_menu_hover_container_menu_li">
                                ...
                                <li><a href="#">حكامة و إدارة نشاط المقاولة</a>
                                    <ul class="side_menu_hover_container_menu_li">
                                ...
                                <li><a href="#">إدارة اللوجستيك والموردين</a>
                                    <ul class="side_menu_hover_container_menu_li">
                                ...
                                <li><a href="https://intaliq.ma/?ref=massar_almoukawil_tta" target="_blank">معلومات من Intaliq بواسطة CGEM </a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="card_bg_white full_raduis mt-3 col_card_2">
                    ...
                    <div class="card_body">
                        <ul class="side-bar-links">
                            ...
                            <li> <a href="{{asset('503')}}">المواكبة التجارية</a></li>


                            <li> <a href="{{asset('503')}}">المواكبة الإدارية</a></li>


                            <li><a href="{{asset('503')}}">	المواكبة في التشبيك</a></li>


                            <li><a href="{{asset('503')}}">المواكبة في التكوين</a></li>


                            <li><a href="{{asset('503')}}">المواكبة الرقمية</a></li>

                        </ul>
                    </div>
                </div>
            </div>
            <div class="col col-sm-6 col-xxl-8">
                <div class="web-cartographie">
                    <img src="{{asset('images/Cartographie(v.AR).png')}}" alt="">
                </div>
            </div>
                    ...
                    <div class="body_card_right">
                        <ul class="side-bar-links-2">
                            ...
                            <a href="#exampleModal" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                <li>إنشاء المقاولة</li>
                            </a>
                            <a href="#asc" data-bs-toggle="modal" data-bs-target="#asc">
                                <li>المساعدة في انشاء المقاولة</li>
                            </a>
                            ...
                            <a href="#acds" data-bs-toggle="modal" data-bs-target="#acds">
                                <li>مواكبة الشركات الناشئة</li>
                            </a>
                            <a href="#arh" data-bs-toggle="modal" data-bs-target="#arh">
                                <li>المواكبة في التشغيل</li>
                            </a>
                            ...
                            <a href="#aide_financement" data-bs-toggle="modal" data-bs-target="#aide_financement">
                                <li>المواكبة في التمويل</li>
                            </a>
                            <a href="{{asset('/risques/fmsar')}}">
                                <li>التأمين / المخاطر</li>
                            </a>
        ...
        <div class="row footer_row mt-3 ">
            <div class="col col-3 col-xxl-2">
                <div class="card_bg_white full_raduis footer_bg position-relative">
                    <a href="#" class="btn_footer">
                        <span class=" position-absolute top-50 start-50 translate-middle text-center">
                            <i class="fas fa-comments"></i> <br> نقاش <small>تواصل مع باقي المقاولين</small>
                        </span>
                    </a>
                </div>
            </div>
            ...
            <div class="col col-3 col-xxl-2">
                <div class="card_bg_white full_raduis footer_bg">
                    <div class="row align-items-center h-100">
                        <div class="col container">
                            <div class="card-small-title">
                                <span id="slider_title">المنصة من تطوير</span>
                            </div>
                            <div class="customer-logos-3 slider">
                                <div class="customer-logos-2 slider">
                                    <div class="logo-simple slide">
                                ...
                                <div class="customer-logos-2 ">
                                    <div class="logo-simple ">
                                        <img src="{{asset('images/logos/logo_mfe.png')}}" alt="">
                                    </div>
...
$(document).ready(function() {
   ...
   function sponsortitle(){
    ...
    setTimeout(function() {
    $("#slider_title").html('المنصة من تطوير');
    sponsortitle();
  }, 7500);
  }
