        ...
        <div class="body_card mt-5 mb-5">
            ...
            <div class="container-body ">
                <div class="section-title-br mb-5">
                    <h1>
                        Formulaire de la partie accompagnament sur formations spécifiques
                    </h1>
                </div>
                <div class="container1">
                    ...
                    <form class="form-container">
                        <div class="row row-cols-1 mx-auto justify-content-center">
                            ...
                            <div class="col mb-3">
                                <label class="form-label">Nature du besion en formation que vous avez :</label>
                                <input type="text" class="form-control" placeholder="Nature du besion en formation que vous avez"/>
                            </div>
                            <div class="col mb-3">
