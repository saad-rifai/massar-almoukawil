            ...
            <div class="container-body">
                ...
                <div class="section-title-br">
                    <h1>Etape n°1 :
                        ...
                        <h3>
                            (optionnelle si on opte pour le choix d’un
                        nom commercial)
                        </h3>
                </div>
                <br>
...
tutelle du Ministère de l’Industrie, du Commerce, de l’Investissement et de l’Economie Numérique. <br>
Le premier document à obtenir avant même toutes les démarches administratives est le certificat négatif, c’est un
document qui atteste que le nom commercial que vous avez choisi pour l’immatriculation au registre du commerce n’a
pas été déjà utilisé par quelqu’un d’autre. 
                        ...
                        <table class="table table_model_2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="width: 60%">
                                       <p >
                                        1. La première étape consiste à faire une demande soit en ligne
                                        sur le site officiel de l’OMPIC, soit directement au niveau de
                                        l’Office à Casablanca ou dans l’une des antennes régionales
