@section('title', 'Capital Retournement ')
@section('description', "Les investisseurs apportent un financement en fonds propres à des entreprises en difficulté.")
        ...
        <div class="body_card mt-5 mb-5">
            <div class="container-body">
                ...
                <div class="text-containet">
                    ...
                    <p class="section_normale_text">
                        Le capital retournement appelé aussi « la recapitalisation » donne aux dirigeants l’opportunité et les moyens de mettre en place des mesures de redressement de l’activité pour permettre le retour aux bénéfices.
...
Ne pas être en situation contentieuse avec un autre organisme financier.
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <p class="section_normale_text">
                                Le montant d’investissement est déterminé en fonction des dépenses à engager dans le cadre du redressement de l’entreprise et des possibilités de remboursements dégagées par la rentabilité prévisionnelle.
                            </p>
                        </div>
                        <div class="col">
                            <h2 class="blue-section-title">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <h2 class="blue-section-title">Indicateur de Performance </h2>
                            <p class="section_normale_text">
                                Dilution de Capital.
                            </p>
                        </div>
        ...
        <div class="row">
            <div class="col">
                <a href="{{(asset('/financement/linvestissement-en-capital/capital-transmission'))}}">
                    <button class="previous_btn">Capital transmission </button>
            </a>
            </div>
            <div class="col">
