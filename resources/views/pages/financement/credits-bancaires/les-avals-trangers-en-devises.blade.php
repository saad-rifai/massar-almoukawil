@section('title', 'Les avals étrangers en devises')
...
<body>
    <div class="container-lg">
        ...
        <div class="body_card mt-5 mb-5">
            <div class="container-body">
                ...
                <div class="section-title-br">
                    <h1>Les avals étrangers en devises</h1>
                </div>
                <br>
                <br>
                <div class="text-containet">
                    ...
                    <p class="section_normale_text">
                        C’est un engagement ferme que prend la banque pour honorer un ou plusieurs effets tirés sur un client de la
                        banque.
                    </p>
                </div>
                ...
                <div class="text-containet">
                    <div class="row">
                        <div class="col">
                            ...
                            <p class="section_normale_text">
                                ...
                                Agriculteurs, Personnes physiques, Personnes
                                morales, GIE, 
                            </p>
                        </div>
                        <div class="col">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <p class="section_normale_text">
                                La durée dans ce cas est fonction de l’usance des effets avalisés par la banque.
                            </p>
                        </div>
                    </div>
                    <br>
        ...
        <div class="row">
            <div class="col">
                <a href="{{(asset('financement/credits-bancaires/les-cr-dits-documentaires'))}}">
                    <button class="previous_btn">Les crédits documentaires</button>
                </a>
            </div>
            <div class="col">
                <div class="next-btn-box">
                    <a href="{{(asset('financement/credits-bancaires/les-cautions-en-devises'))}}">
                        <button class="next_btn">Les cautions en devises</button>
                    </a>
                </div>
