@section('title', 'Les avances sur créances nées sur l’étranger')
@section('description', 'C’est une avance faite par la banque pour l’encaissement du produit de l’expédition.
')
        ...
        <div class="body_card mt-5 mb-5">
            <div class="container-body">
                ...
                <div class="section-title-br">
                    <h1>Les avances sur créances nées sur l’étranger</h1>
                </div>
                <br>
                <br>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <p class="section_normale_text">
                                ...
                                <strong>Besoin théorique : (Chiffre d’affaires export x nombre de jours) / 360</strong>
                        ...
                        <div class="col">
                            ...
                            <p class="section_normale_text">
                                La durée ne peut dépasser les 150* jours ni la date d’échéance de l’autorisation. <br>
                               <strong> *</strong> Obligation de l’office des changes de rapatrier les fonds dans un délai de 150 jours. 
                            </p>
                        </div>
                    </div>
                    <br>
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="next-btn-box">
                    <a href="{{(asset('financement/credits-bancaires/les-mobilisations-des-cr-ances-n-es-en-devises'))}}">
                        <button class="next_btn">mobilisations des créances nées en devises</button>
                    </a>
                </div>
