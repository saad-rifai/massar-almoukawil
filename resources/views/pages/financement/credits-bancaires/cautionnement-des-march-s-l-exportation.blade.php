@section('title', ' Cautionnement des marchés à l’exportation')
@section('description', 'Accordée aux entreprises marocaines soumissionnaires de marché à l’étranger. Dans ce cas, la banque intervient
pour l’octroi des garanties exigées par les maîtres d’ouvrage.')
        ...
        <div class="body_card mt-5 mb-5">
            <div class="container-body">
                ...
                <div class="section-title-br">
                    <h1>Cautionnement des marchés à l’exportation</h1>
                </div>
                <br>
                <br>
                <div class="text-containet">
                    ...
                    <p class="section_normale_text">
                        Accordée aux entreprises marocaines soumissionnaires de marché à l’étranger. Dans ce cas, la banque intervient
                        pour l’octroi des garanties exigées par les maîtres d’ouvrage.
                ...
                <div class="text-containet">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <p class="section_normale_text">
                                En fonction de la demande du maitre d’ouvrage.
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="next-btn-box">
                    <a href="{{(asset('financement/credits-bancaires/avances-sur-march-s-publics-pr-financement-de-march-s'))}}">
                        <button class="next_btn">Avances sur marchés publics</button>
                    </a>
                </div>
