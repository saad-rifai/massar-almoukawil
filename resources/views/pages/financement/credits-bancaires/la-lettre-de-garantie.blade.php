@section('title', ' La lettre de garantie')
            ...
            <div class="container-body">
                ...
                <div class="text-containet">
                    ...
                    <p class="section_normale_text">
                        C’est un document délivré par la banque en faveur d’un transporteur de marchandises importées. Le montant figurant
                        sur la lettre correspond à la valeur de la marchandise, ainsi que les effets de cette lettre cessent après un an.
        ...
        <div class="row">
            <div class="col">
                <a href="{{(asset('financement/credits-bancaires/avances-sur-march-s-publics-pr-financement-de-march-s'))}}">
                    <button class="previous_btn">Avances sur marchés publics</button>
                </a>
            </div>
            <div class="col">
                <div class="next-btn-box">
                    <a href="{{(asset('financement/credits-bancaires/les-cr-dits-documentaires'))}}">
                        <button class="next_btn"> Les crédits documentaires</button>
                    </a>
                </div>
