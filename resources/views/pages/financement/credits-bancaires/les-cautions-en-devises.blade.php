@section('title', 'Les cautions en devises')
            ...
            <div class="container-body">
                ...
                <div class="text-containet">
                    ...
                    <p class="section_normale_text">
                        C’est un engagement que prend la banque vis-à-vis d’un fournisseur étranger de biens ou de services de se
                        substituer à son client en cas de défaillance de ce dernier.
                    </p>
                </div>
        ...
        <div class="row">
            <div class="col">
                <a href="{{(asset('financement/credits-bancaires/les-cautions-en-devises'))}}">
                    <button class="previous_btn">Les cautions en devises</button>
                </a>
            </div>
            <div class="col">
                <div class="next-btn-box">
                    <a href="{{(asset('financement/credits-bancaires/le-refinancement-import-en-devises'))}}">
                        <button class="next_btn">Le refinancement import en devises</button>
                    </a>
                </div>
