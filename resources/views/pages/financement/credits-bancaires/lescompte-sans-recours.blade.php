@section('title', ' L’escompte sans recours')
            ...
            <div class="container-body">
                ...
                <div class="text-containet">
                    ...
                    <p class="section_normale_text">
                        Appelé aussi le forfaiting, c’est une technique de financement et de garantie de créances nées
                        d’opérations
                        d’importation. C’est un engagement ferme d’un forfaiteur, en faveur d’un fournisseur étranger,
                        d’acheter une créance
                        commerciale née sur un importateur marocain client de la banque. La créance est matérialisée par
        ...
        <div class="row">
            <div class="col">
                <a href="{{(asset('financement/credits-bancaires/lescompte-commercial'))}}">
                    <button class="previous_btn">L’escompte commercial</button>
                </a>
            </div>
            <div class="col">
                <div class="next-btn-box">
                    <a href="{{(asset('financement/credits-bancaires/les-avances-sur-facture-ou-Factoring'))}}">
                        <button class="next_btn">avances sur facture</button>
                    </a>
                </div>
