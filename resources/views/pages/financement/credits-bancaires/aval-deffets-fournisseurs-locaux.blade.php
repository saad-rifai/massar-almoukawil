@section('title', ' Aval d’effets fournisseurs locaux')
        ...
        <div class="body_card mt-5 mb-5">
            <div class="container-body">
                ...
                <div class="section-title-br">
                    <h1> Aval d’effets fournisseurs locaux</h1>
                </div>
                <br>
                <br>
                ...
                <div class="text-containet">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <p class="section_normale_text">
                                Le plafond de crédit est déterminé en fonction des besoins de l’entreprise.
        ...
        <div class="row">
            <div class="col">
                <a href="{{(asset('financement/credits-bancaires/caution-libre'))}}">
                    <button class="previous_btn">Caution libre</button>
                </a>
            </div>
            <div class="col">
                <div class="next-btn-box">
                    <a href="{{(asset('financement/credits-bancaires/cautionnement-des-march-s-locaux'))}}">
                        <button class="next_btn">Cautionnement des marchés locaux</button>
                    </a>
                </div>
