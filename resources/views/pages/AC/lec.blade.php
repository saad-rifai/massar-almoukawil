...
<body>
    <div class="container-lg">
        ...
        <div class="body_card mt-5 mb-3">
            <div class="container-body">
                ...
                <div class="section-title-br">
                    <h1>L'Ordre des Experts-Comptables
                    </h1>
                </div>
                <br>
                <br>
                ...
                <div class="text-containet">
                    ...
                    <p class="section_normale_text">
                        Du côté des entreprises, les experts-comptables jouent avant tout un rôle important pour
                        accompagner, conseiller et
                        simplifier les contraintes administratives liées à :


                    <ul class="section_normale_list">

                        <li>La création juridique de l’entreprise
                        </li>
                        <li> La comptabilité : maintenir, gérer et attester la régularité de la comptabilité ;</li>
                        <li>La comptabilité : maintenir, gérer et attester la régularité de la comptabilité ;</li>
                        <li> Secrétariat juridique ;</li>
                        <li>Le management ;
                        </li>
                        <li>Gestion sociale (personnel), gestion de la paie ;</li>
                        <li>Les finances : aide à l’octroi du financement ;</li>
                        <li>La fiscalité : préparer les déclarations, assister aux audits ;</li>
                        <li>Conseil export, stratégie ;</li>
                        <li>Évaluation d’entreprise ;</li>
                        <li> Aide administrative : restructuration informatique, recrutement.</li>
                    </ul>
                    <br>
        ...
        <div class="row">
            <div class="col">
                <a href="{{(asset('/ac/cri'))}}">
                    <button class="previous_btn">CRI</button>
            </a>
            </div>
            <div class="col">
                ...
                <div class="next-btn-box">
                    <a href="{{(asset('/ac/onm'))}}">
                        <button class="next_btn">L'Ordre des Notaires</button>
                    </a>
                </div>
            </div>
        </div>
